...
public class LayeredStage extends Stage {
	...
	public LayeredStage(Viewport viewport, Batch batch, CPos startingPos) {
		super(viewport, batch);
		initLayers(startingPos);
	}

	public LayeredStage(Viewport viewport, CPos startingPos) {
		super(viewport);
		initLayers(startingPos);
	}

	private void initLayers(CPos startingPos) {
		addActor(new Group());
		addActor(new Group());
		addActor(new TiledLayer(this, startingPos));
		addActor(new Group());
		addActor(new Group());
	}
